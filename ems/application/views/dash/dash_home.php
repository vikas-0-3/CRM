...
<?php $this->load->view('dash/header'); ?>
    ...
    <title><?php echo strtoupper($b).' -'; ?> CRM</title>
...
<?php $this->load->view('dash/left_nav'); ?>

  <iframe src="<?php echo site_url(); ?>dash/def_dash" frameborder="0" id="myiframe" name="iframe_c"></iframe>
